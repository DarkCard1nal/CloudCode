...
class Metrics:
    def __init__(self):
        ...
        self.success_count = Counter('http_requests_success', 'Number of successful requests', ['endpoint'])
        self.failure_count = Counter('http_requests_failure', 'Number of failed requests', ['endpoint'])
